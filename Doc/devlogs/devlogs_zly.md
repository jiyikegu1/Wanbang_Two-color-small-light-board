...
- 小灯板V0.2：1、宽度改成6.8mm（现在是6.8*12mm）； 2 LED的PAD由原来间距1mm，改为了2.5mm（如图）； 3 、矩形框四脚下方半圆弧倒角半径0.5mm，上方30度锐角（具体见板框图）；4、增加版本号V0.2；`5、LED灯与最初设计要求下移了0.5mm，修改第二版时发现，但对方未提及修改，未作改动`；6、由于30度倒角在AD软件中暂不知道怎么处理，改为CAD导入板框设计；7、V0.2下单100片。
